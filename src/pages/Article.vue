<template>
	<div class="article">
		...
		<div class="article_tbl" v-loading='loading'>
	      ...
	      <el-table-column prop="liststyle" label="列表样式" width="120" align="center"> </el-table-column>
	       <el-table-column prop="publishtime" label="发布时间" align="center"></el-table-column>
	       <el-table-column prop="readtimes" label="阅读次数" width="100" align="center"></el-table-column>
			...
			batchDeleteArticles(){
		    	...
		    	this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
		          ...
		          type: 'warning'
		        	...
		        	axios.post('/manager/article/batchDeleteArticle',{ids}).then(()=>{
			    		this.$notify({
				          title: '成功',
				          message: '批量删除成功',
				          type: 'success'
